...
int FEB_CAN_State_PrintOne(const char *name, int (*printf_fn)(const char *fmt, ...))
{
    ...
    if (strcmp(name, "front_sensor_heartbeat_message") == 0)
    {
        ...
        printf_fn("  imu_init_failed                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.imu_init_failed);
        printf_fn("  imu_read_failed                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.imu_read_failed);
        printf_fn("  mag_init_failed                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.mag_init_failed);
        printf_fn("  mag_read_failed                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.mag_read_failed);
        printf_fn("  gps_init_failed                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.gps_init_failed);
        printf_fn("  fusion_uncalibrated              = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.fusion_uncalibrated);
        printf_fn("  lp_out_of_range                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.lp_out_of_range);
        printf_fn("  error7                           = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.error7);
        printf_fn("  gps_no_fix                       = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.gps_no_fix);
        printf_fn("  gps_stale                        = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.gps_stale);
        printf_fn("  gps_link_slow                    = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.gps_link_slow);
        printf_fn("  wss_left_no_signal               = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.wss_left_no_signal);
        printf_fn("  wss_right_no_signal              = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.wss_right_no_signal);
        ...
        printf_fn("  can_bus_off                      = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.can_bus_off);
        printf_fn("  can_tx_overflow                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.can_tx_overflow);
        printf_fn("  can_rx_overflow                  = %ld\r\n", (long)feb_can_state.front_sensor_heartbeat_message.data.can_rx_overflow);
    ...
    if (strcmp(name, "rear_sensor_heartbeat_message") == 0)
    {
        ...
        printf_fn("  imu_init_failed                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.imu_init_failed);
        printf_fn("  imu_read_failed                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.imu_read_failed);
        printf_fn("  mag_init_failed                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.mag_init_failed);
        printf_fn("  mag_read_failed                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.mag_read_failed);
        printf_fn("  gps_init_failed                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.gps_init_failed);
        printf_fn("  fusion_uncalibrated              = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.fusion_uncalibrated);
        printf_fn("  lp_out_of_range                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.lp_out_of_range);
        printf_fn("  error7                           = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.error7);
        printf_fn("  gps_no_fix                       = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.gps_no_fix);
        printf_fn("  gps_stale                        = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.gps_stale);
        printf_fn("  gps_link_slow                    = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.gps_link_slow);
        printf_fn("  wss_left_no_signal               = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.wss_left_no_signal);
        printf_fn("  wss_right_no_signal              = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.wss_right_no_signal);
        ...
        printf_fn("  can_bus_off                      = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.can_bus_off);
        printf_fn("  can_tx_overflow                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.can_tx_overflow);
        printf_fn("  can_rx_overflow                  = %ld\r\n", (long)feb_can_state.rear_sensor_heartbeat_message.data.can_rx_overflow);
